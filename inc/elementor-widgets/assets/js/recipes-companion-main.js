(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".recipes-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".recipes-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".recipes-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.recipes-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.recipes-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.recipes-subscribe-newsletter-area');
    if ($subscribe.length) {
