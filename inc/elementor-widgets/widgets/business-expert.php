...
/**
 *
 * Recipes elementor business expert section widget.
 *
 * @since 1.0
 */
class Recipes_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'recipes-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'recipes-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'recipes-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'recipes-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'recipes-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'recipes-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'recipes-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'recipes-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'recipes-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'recipes-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
