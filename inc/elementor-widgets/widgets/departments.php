...
/**
 *
 * Recipes elementor departments section widget.
 *
 * @since 1.0
 */
class Recipes_Departments extends Widget_Base {

	public function get_name() {
		return 'recipes-departments';
	}

	public function get_title() {
		return __( 'Departments', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'recipes-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'recipes-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Learn More', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                        ],
                    ],
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'recipes-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'recipes-companion' ),
                        'btn_text'   => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'recipes-companion' ),
        ...
        $this->add_control(
            'big_title_col', [
                'label' => __( 'Big Title Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'recipes_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
