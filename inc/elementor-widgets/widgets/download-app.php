...
/**
 *
 * Recipes elementor download app section widget.
 *
 * @since 1.0
 */
class Recipes_Download_App extends Widget_Base {

	public function get_name() {
		return 'recipes-download-app';
	}

	public function get_title() {
		return __( 'Download App', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Download App content', 'recipes-companion' ),
			]
        );
        $this->add_control(
            'sec_img',
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Best size is 195x220', 'recipes-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download app to get recipes from Everywhere', 'recipes-companion' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Apple Sections', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'apple_big_text',
            [
                'label' => esc_html__( 'Big Text', 'recipes-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Available', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'apple_small_text',
            [
                'label' => esc_html__( 'Small Text', 'recipes-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'on App Store', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'apple_url',
            [
                'label' => esc_html__( 'Apple Store URL', 'recipes-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Play Store Sections', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Download', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'from Play Store', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'playstore_url',
            [
                'label' => esc_html__( 'Play Store URL', 'recipes-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    $left_img = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'recipes_download_app_small_thumb_195x220', '', array( 'alt' => $sec_title ) ) : '';
    $bottom_img = !empty( $settings['bottom_img']['id'] ) ? wp_get_attachment_image( $settings['bottom_img']['id'], 'recipes_download_app_small_thumb_195x220', '', array( 'alt' => $sec_title ) ) : '';
