...
/**
 *
 * Recipes elementor facilities section widget.
 *
 * @since 1.0
 */
class Recipes_Facilities extends Widget_Base {

	public function get_name() {
		return 'recipes-facilities';
	}

	public function get_title() {
		return __( 'App Facilities', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'recipes-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using recipes',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'recipes-companion' ),
		...
		$this->add_control(
            'facilities', [
                ...
                'fields' => [
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Select Icon', 'recipes-companion' ),
                        'label_block' => true,
            ...
            <div class="row">
                ...
                if( is_array( $facilities ) && count( $facilities ) > 0 ) {
                    foreach( $facilities as $item ) {
                        $item_icon = ( !empty( $item['item_icon'] ) ) ? RECIPES_DIR_ICON_IMG_URI . $item['item_icon'] : '';
