...
/**
 *
 * Recipes elementor faq section section widget.
 *
 * @since 1.0
 */
class Recipes_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'recipes-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'recipes-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Faq Image', 'recipes-companion' ),
                'description' => esc_html__( 'Best size is 490x480', 'recipes-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'recipes-companion' ),
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Faq Title', 'recipes-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Frequently ask', 'recipes-companion' )
            ]
        );
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Adieus who direct esteem It esteems luckily?', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem esteems luckily or picture placing drawing.', 'recipes-companion' ),
                    ],
                ],
                'default'   => [
                    [      
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $sec_img = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'recipes_accordion_thumb_490x480', '', array( 'alt' => $sec_title ) ) : '';
