...
/**
 *
 * Recipes elementor features section widget.
 *
 * @since 1.0
 */
class Recipes_Features extends Widget_Base {
	...
	public function get_title() {
		return __( 'App Features', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_content',
			[
				'label' => __( 'Features content', 'recipes-companion' ),
			]
        );
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Image', 'recipes-companion' ),
                'description' => esc_html__( 'Best size is 372x655', 'recipes-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Best size is 561x707', 'recipes-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Features', 'recipes-companion' ),
            ...
            'features', [
                ...
                'fields' => [
                    [
                        ...
                        'default'     => __( 'Sign Up for free', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Short Text', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'recipes-companion' ),
                    ],
                ],
                'default'   => [
                    [      
                        'item_title'    => __( 'Sign Up for free', 'recipes-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'recipes-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Make your profile', 'recipes-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'recipes-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Enjoy the app', 'recipes-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'recipes-companion' ),
                    ],
                ]
            ]
    ...
    $left_img  = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'recipes_service_man_thumb_372x655', '', array( 'alt' => 'left image' ) ) : '';
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'recipes_service_right_thumb_561x707', '', array( 'alt' => 'right image' ) ) : '';
