...
/**
 *
 * Recipes elementor portfolio section widget.
 *
 * @since 1.0
 */
class Recipes_Portfolio extends Widget_Base {

	public function get_name() {
		return 'recipes-portfolio';
	}

	public function get_title() {
		return __( 'Portfolio', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'portfolio_content',
			[
				'label' => __( 'Portfolio content', 'recipes-companion' ),
			]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Portfolios', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Portfolios', 'recipes-companion' ),
            ...
            'portfolios', [
                ...
                'fields' => [
                    [
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default'     => __( 'Product Design', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'item_img',
                    ...
                    [
                        'name' => 'col_size',
                        'label' => __( 'Select Column Size', 'recipes-companion' ),
                        // 'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Section', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'btn_title',
            [
                'label' => esc_html__( 'Button Title', 'recipes-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'More Folio', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
                    ...
                    foreach( $portfolios as $item ) {
                        ...
                        switch ($col_size) {
                            case '5':
                                ...
                                $img_size = 'recipes_portfolio_thumb_460x410';
                                break;
                            case '7':
                                $wrap_class = 'col-xl-7 col-md-7';
                                $img_size = 'recipes_portfolio_thumb_656x410';
                                break;
                            default:
                                $wrap_class = 'col-xl-4 col-md-6 col-lg-4';
                                $img_size = 'recipes_portfolio_thumb_362x410';
                                break;
                        }
