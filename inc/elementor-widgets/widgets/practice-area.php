...
/**
 *
 * Recipes elementor parctice area widget.
 *
 * @since 1.0
 */
class Recipes_Practice_Area extends Widget_Base {

	public function get_name() {
		return 'recipes-practice-area';
	}

	public function get_title() {
		return __( 'Practice Area', 'recipes-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Practice Area content', 'recipes-companion' ),
			]
        );
        ...
        $this->add_control(
            'big_title',
            [
                'label' => esc_html__( 'Big Title', 'recipes-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Practice Area', 'recipes-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Practice Items', 'recipes-companion' ),
		...
		$this->add_control(
            'practice_items', [
                ...
                'fields' => [
                    [
                        'name' => 'item_bg_img',
                        'label' => __( 'Item BG Image', 'recipes-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Item Icon', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::ICON,
                        'default'     => 'flaticon-case',
                        'options'     => recipes_themify_icon(),
                    ],
                    [
                        'name' => 'item_title',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Business Law', 'recipes-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                    ...
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Anchor Text', 'recipes-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                    ...
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Anchor URL', 'recipes-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [     
                        ...
                        'item_title' => __( 'Business Law', 'recipes-companion' ),
                    ...
                    [     
                        ...
                        'item_title' => __( 'Finance Law', 'recipes-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Family Law', 'recipes-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Education Law', 'recipes-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'recipes-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_mid_bg_col', [
                'label' => __( 'Middle Section Bg Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Single Service Item Styles', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Icon Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_col', [
                'label' => __( 'Button Color', 'recipes-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Hover Styles', 'recipes-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
            ...
            <div class="row no-gutters">
                ...
                if( is_array( $practice_items ) && count( $practice_items ) > 0 ) {
                    foreach( $practice_items as $item ) {
                        ...
                        $item_bg_img  = !empty( $item['item_bg_img']['id'] ) ? wp_get_attachment_image( $item['item_bg_img']['id'], 'recipes_practice_thumb_448x500', '', array('alt' => $item_title . ' image' ) ) : '';
