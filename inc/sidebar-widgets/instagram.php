...
----------------------------------------*/
class recipes_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('recipes_instagram_photo',esc_html__('[ Recipes ] Intagram Photo','recipes-companion'),array(
			'description' => esc_html__('Recipes Instagram Photo Widget','recipes-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'recipes-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'recipes-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'recipes-companion'); ?></label>
...
if(!function_exists('recipes_instagram_widgets')):
	function recipes_instagram_widgets(){
		register_widget('recipes_instagram_photo');
	}
	add_action('widgets_init','recipes_instagram_widgets');
endif;
