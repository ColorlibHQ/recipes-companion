...
class Recipes_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'recipes_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Recipes ] Social Links', 'recipes-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'recipes-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'recipes-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'recipes-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'recipes-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'recipes-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'recipes-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'recipes-companion'); ?></label>
...
} // Class recipes_social_links ends here


// Register and load the widget
function recipes_social_links_widget_load() {
	register_widget( 'Recipes_social_links' );
}
add_action( 'widgets_init', 'recipes_social_links_widget_load' );